...
(
	...
	// TINA: PEA 0 writes to base address, PEA 1 writes to base address offset by Output Size (y_wr + 1)
	assign CTRL_LDM_Store_out	= {destination_LDM_wr, starting_address_LDM_wr};
	assign CTRL_LDM_Store_1_out = {destination_LDM_wr, starting_address_LDM_wr + y_wr + 1'b1};
