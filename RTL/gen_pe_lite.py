...
(
    ...
    //          		Write Address Logic                    // 
    //-----------------------------------------------------//
    assign ALU_addr_out = {CTRL_LDM_Store_in[`D_LDM_BITS+`SA_LDM_BITS-1:`SA_LDM_BITS], ALU_LDM_addrb_rg + CTRL_LDM_Store_in[`SA_LDM_BITS-1:0]};
    assign ALU_en_out   = ALU_valid_out & En_in;
