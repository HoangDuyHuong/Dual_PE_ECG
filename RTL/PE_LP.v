...
(
	...
	///*** From PEA 1 (PE_lite) ***///
	input  wire signed [`WORD_BITS-1:0]         PE1_ALU_out_in,
	input  wire                                 PE1_ALU_valid_in,
	input  wire [`D_LDM_BITS+`LDM_ADDR_BITS-1:0] PE1_ALU_addr_in,
	input  wire                                 PE1_ALU_en_in,
	...
	LSU_LP lsu(
		...
		///*** Thêm mới: From the ALU (PEA 1) ***///
		.PE1_LDM_addra_in(PE1_ALU_addr_in),
		.PE1_LDM_dina_in(PE1_ALU_out_in),
		.PE1_LDM_ena_in(PE1_ALU_en_in),
		.PE1_LDM_wea_in(PE1_ALU_en_in), // Cứ có Valid (en_in = 1) là ghi
